...
extension HarnessDefinition {
    var isMetaHarness: Bool {
        ["warp", "paseo", "t3-code", "conductor", "superset", "cmux", "orca", "herdr", "emdash", "antigravity", "openchamber", "vibe-kanban"].contains(id)
    }
}

extension HarnessDefinition {
    /// Editorial popularity order, not live usage statistics. See catalog documentation.
    var discoveryRank: Int {
        let order = ["claude-code", "cursor", "codex", "gemini-cli", "opencode", "antigravity-ide", "kiro", "hermes", "zcode",
                     "warp", "antigravity", "conductor", "orca", "cmux", "t3-code", "paseo", "superset", "vibe-kanban", "emdash", "herdr", "openchamber"]
