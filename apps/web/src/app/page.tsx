...
export default function Home() {
  return <>
    ...
    <header className="site-header wrap"><Brand /><nav aria-label="Main navigation"><a href="#workspace">The workspace</a><a href="#benchmarks">Rankings</a><a href="#how-it-works">How it works</a><Link href="/press">Press kit</Link></nav><ThemeToggle /><a href={site.download} className="nav-cta" download>Get the app<ArrowUpRightIcon size={15} /></a></header>
    <main id="main">
      <section className="hero wrap">
        <div className="hero-showcase">
          <div className="hero-copy"><p className="eyebrow">THE MAC APP FOR YOUR AI STACK</p><h1>Your AI stack.<br /><span>Under control.</span></h1><p className="hero-description">Manage your coding tools, discover skills and MCPs, and compare models. One native Mac app. Free and open source.</p><div className="hero-actions"><Download /><a className="hero-source-link" href="#benchmarks">Explore model rankings <ArrowRightIcon size={15} /></a></div><div className="hero-availability"><AppleLogoIcon size={15} weight="fill" /> macOS 14 or later <span>·</span> Apple silicon and Intel</div></div>
          <ProductTour />
        </div>
      </section>
      <ToolMarquee />
      ...
      <section className="download-section wrap" id="install"><Reveal><Image src="/brand/app-icon.png" alt="Harness Manager app icon" width={96} height={96} /><h2>Your stack, sorted.<br /><span>Back to building.</span></h2><p>One workspace for your AI tools. Free and open source.</p><Download /><div className="download-meta">macOS 14+ · Apple silicon & Intel</div><p className="release-note">Early preview. This build is not yet notarized.<br />macOS may require approval in Privacy & Security on first launch.</p></Reveal></section>
    </main>
